...
echo "concourse_worker_keys\t\t\t:" > ${worker_yaml_output}
...
echo "concourse_key_session_public  : ${public}" >> ${web_yaml_output}
echo "concourse_key_session_private : |" >> ${web_yaml_output}
...
echo "concourse_key_tsa_public      : ${public}" >> ${web_yaml_output}
echo "concourse_key_tsa_private     : |" >> ${web_yaml_output}
echo "${private}" | python -c "${python_ident}" >> ${web_yaml_output}
